-- Security tests for Phase 12: the Dabz Apparel online shop (docs/spec.md).
--
...
do $$
begin
  raise notice '--- phase 12: a stranger ---';
...
declare
  ...
  v_item record;
begin
  raise notice '--- phase 12: the website places an order ---';
...
declare
  v_ignored jsonb;
begin
  raise notice '--- phase 12: what the function refuses ---';
...
do $$
begin
  raise notice '--- phase 12: staff without the apparel permission ---';
...
declare
  v_order_id uuid;
begin
  raise notice '--- phase 12: staff with the apparel permission ---';
...
declare
  ...
  v_payment_id uuid;
begin
  raise notice '--- phase 12: quoting, confirming and payments ---';
...
declare
  ...
  v_totals record;
begin
  raise notice '--- phase 12: the owner voids a payment ---';
...
declare
  ...
  v_stage record;
begin
  raise notice '--- phase 12: production steps ---';
...
declare
  ...
  v_steps integer;
begin
  raise notice '--- phase 12: the DTF path ---';
...
declare
  v_order_id uuid;
begin
  raise notice '--- phase 12: the date and the last look from outside ---';
